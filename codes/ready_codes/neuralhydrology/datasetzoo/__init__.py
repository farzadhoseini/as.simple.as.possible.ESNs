...
from neuralhydrology.datasetzoo.swisshourly import SwissHourly
...
_datasetZooRegistry.register_dataset_class("basquehourly", BasqueHourly)
_datasetZooRegistry.register_dataset_class("swisshourly", SwissHourly)
